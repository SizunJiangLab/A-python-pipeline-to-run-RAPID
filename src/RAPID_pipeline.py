# the only parameters you have to change are these three
EXP_DIR='H:/CODEXTransfers/RCC/'   #The path to the raw image folder

columns = 15 #Number of columns you want in the final OMETiff - Calculate this according to the number of regions captured

rows = 13 #Number of rows you want in the final OMETiff - Calculate this according to the number of regions captured
